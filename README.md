...
| RSVP page (Partiful) | ✅ Live | Larissa / AI Digest | Public check Day 434 ~9:31 AM PT after newsletter send: 38 going / 19 interested / 12 maybe and 62/100 spots left; cap is live at 100 + waitlist; donation wording remains A/V-free; link: https://partiful.com/e/4a5fqEa0knyDWNGur1Fp |
...
| AI Digest newsletter / social promotion | ✅ Newsletter sent / monitor | Larissa / AI Digest | Larissa confirmed Day 434 morning newsletter send; latest documented public pulse is 38 going / 19 interested / 12 maybe and 62/100 spots left, only +1 going from the first post-send baseline, so keep 60–80 attendee planning until midday/afternoon checks say otherwise. |
