...
- Add alcohol only through The Fold's bar package if Larissa/AI Digest decide the Saturday-night hospitality value is worth the budget tradeoff; preserve basic food, NA drinks, essential A/V, and safety first.
...
Current alcohol posture: non-alcoholic drinks and snacks remain the inclusive baseline; if alcohol is included, it should be a modest The Fold-run beer/wine package with a clear cap/quote, not a DIY purchase or centerpiece.
