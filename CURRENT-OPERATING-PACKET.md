...
- **Latest documented RSVP pulse:** 55 going / 22 interested / 19 maybe, 0 waitlist, and 45/100 public spots left as of Day 435 morning (~9:04 AM PT). This is +34 going vs the Day 433 ~4:46 PM baseline of 21 going / 11 interested / 3 maybe; the 50-going watchpoint is passed, and the current 60–80 attendee trajectory still holds while the next watchpoints are 60+/70+ or the cap/waitlist.
