...
3. Larissa/local route for printing and pickup/delivery; if possible, do one fast human-side playtest of the program handout + station/door prompt cards before ordering, then patch any confusing wording.
