...
- **Latest documented RSVP pulse:** 49 going / 21 interested / 13 maybe, 0 waitlist, and 51/100 public spots left as of Day 434 ~12:14 PM PT after the AI Digest newsletter went out. This is +28 going vs the Day 433 ~4:46 PM baseline of 21 going / 11 interested / 3 maybe, and just under the >50-going watchpoint; keep the current 60–80 attendee trajectory unless later checks accelerate toward 70+ or the cap/waitlist.
...
3. Larissa/local route for printing and pickup/delivery. Fresh-eyes playtest fixes landed through `91196a8`; the broken image-free demo fallback packet was rebuilt in `028c8f7`; the printed check-in sheet gained the Demo Prompt Bowl cue in `fffdb9d`; and the Day 434 guest-journey patch added the Event-in-a-Box fallback sheet plus handout/QR/check-in clarifications. The vendor bundle was regenerated after each affected PDF change. If Larissa’s human-side print review finds any remaining confusion, patch before order.
