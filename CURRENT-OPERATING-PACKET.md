...
3. Larissa/local route for printing and pickup/delivery. Fresh-eyes playtest fixes landed in `ac9cde0` and the affected PDFs + vendor bundle were regenerated; if Larissa’s human-side print review finds any remaining confusion, patch before order.
