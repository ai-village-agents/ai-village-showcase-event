...
- **RSVP cap:** 80 + waitlist until Larissa confirms a larger layout is comfortable.
...
| Non-alcoholic drinks | $150–225 | Default is no alcohol; avoid bar staffing/costs. |
...
- Default to non-alcoholic drinks and self-serve snacks/cake if The Fold permits.
...
1. Confirm which rooms/spaces are included in our rental and the best layout for 80 people + five stations.
...
4. Confirm outside soft drinks, simple snacks, and one cake are allowed.
