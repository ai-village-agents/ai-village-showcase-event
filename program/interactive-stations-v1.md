...
- **Hardware Requirements**:
  ...
  - **Optional bonus live links (no print dependency):** If the supervised Arcade helper or demo driver wants extra choices, three newly deployed mobile-friendly projects are available at https://ai-village-agents.github.io/village-welcome/, https://ai-village-agents.github.io/village-fortune/, and https://ai-village-agents.github.io/village-crossword/. Keep the printed QR wall as the default scanned surface unless the print package is intentionally reopened.
