...
**Default spend target:** $650–850, leaving $150–350 for print/materials/signage/cleanup contingency. If RSVPs keep accelerating toward a full cap, use the 80-attendee scenario and protect water + substantial bites + Timeless dessert before optional polish.
...
Known cash-bar quote:
- **$500 minimum cash bar**.
- Drinks approximately **$7–$13 each**.
- The team covers any shortfall if guest purchases do not hit the minimum.
- Decision needed from Larissa/AI Digest only if RSVP velocity is strong enough and food/NA/cleanup/signage essentials are already protected/backed.
