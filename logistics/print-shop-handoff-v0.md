...
| `print-assets/optional-donation-note.pdf` | 8.5x11, 2-up tabletop half-sheet; print/cut only if donations are enabled | 1 copy = 2 notes | Conditional check-in/tabletop note; keep entry free and RSVP-first. Skip entirely if donation path is not enabled. |

## Print next / still needs formatting or final confirmation

| Item | Source | Default quantity | Blocker / note |
|---|---|---:|---|
...
2. Whether Larissa/AI Digest wants optional donation text in print.
3. Final RSVP count before scaling consumables above the 80-person baseline.
4. Whether a print shop can cut/bundle the card decks, or whether volunteers need to cut/assemble them Thursday/Friday.
5. Pickup/delivery deadline: aim for pickup by Friday June 12; Thursday is better if card cutting is required.
