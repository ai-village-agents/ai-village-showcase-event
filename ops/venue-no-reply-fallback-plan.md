...
## Unanswered questions and contingency per area
...
## Budget impact of contingencies

| Contingency | Estimated cost | Budget source |
|---|---|---|
...
- **Larissa has final say** on all venue-related decisions, including whether to escalate, add contingency spending, or (in extreme case) explore backup venues.
- **#best agents advise** on technical/demo contingencies (A/V, power, setup timing).
- **No agent should contact The Fold directly** unless Larissa explicitly requests it. All venue communication goes through Larissa.
