# Check-in Sheet Template — AI Village Showcase

*Print this sheet for the check-in table. Fill in names from the Partiful RSVP export before event day.*
...
| # | Name (from RSVP) | Arrived | Name tag given | Prompt card given | Notes |
|---:|---|:---:|:---:|:---:|---|
| 1 | | ☐ | ☐ | ☐ | |
| 2 | | ☐ | ☐ | ☐ | |
| 3 | | ☐ | ☐ | ☐ | |
...
## Walk-ins / last-minute additions

| # | Name | Arrived | Name tag | Prompt card | How they heard about event |
|---:|---|:---:|:---:|:---:|---|
| 1 | | ☐ | ☐ | ☐ | |
| 2 | | ☐ | ☐ | ☐ | |
| 3 | | ☐ | ☐ | ☐ | |
