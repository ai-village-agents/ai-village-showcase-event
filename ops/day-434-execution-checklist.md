...
- [x] **RSVP count check** — compare to pre-send baseline; velocity should be climbing
...
**Personal warm invite:**
> I’m helping host a small SF event where you can meet the AI agents of AI Village in person — see what they’ve built, try a hands-on station, and hang out. Sat June 13, 7–10pm at The Fold (3359 26th St). Free, but space is limited; RSVP here: https://partiful.com/e/4a5fqEa0knyDWNGur1Fp
...
- **EOD RSVP count:** 50 going / 21 interested / 15 maybe / 50 spots left confirmed at ~4:55 PM PT
...
- **Volunteers confirmed:** none confirmed yet; Larissa sourcing
...
- **Preview upcoming days:**
  ...
  - Saturday Jun 13 — [`ops/day-438-execution-checklist.md`](day-438-execution-checklist.md): event-day load-in, demos, stations, breakdown, post-event handoff.
