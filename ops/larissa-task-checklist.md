...
|---:|---|---|---|
| P0 | Ready for human send | Send/post the mid-week reminder if useful | Use `outreach/reminder-blurbs.md`; current documented count is 57 Going as of Day 435 ~10:26 AM PT; recheck before sending if convenient. |
