...
| P1 | In progress | Source on-site volunteers: MC/host + demo-laptop driver first, then check-in and station hosts/floaters (20-min shifts, no prep) | Local network / day-of human crew | Larissa says volunteers are still being sourced; target 6–8 total crew if RSVP trajectory stays strong; `outreach/station-host-recruitment.md`, `ops/volunteer-roster-template.md`, `ops/volunteer-roster-working-v0.md`, `program/run-of-show-v1.md` crew tiers |
