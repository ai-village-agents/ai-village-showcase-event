...
| P0 | Done / monitor | Raise RSVP cap to 100 + waitlist in Partiful | Larissa said Day 433 that a cap of 100 makes sense; venue suggested free-event no-show buffer | Public page check Day 433 ~4:43 PM shows 21 going and 79/100 spots left (`maxCapacity: 100`), waitlist enabled, and accessibility line visible; live donor copy still needs stale “cover A/V” wording removed. Monitor after newsletter. |
...
- Cap decision: Larissa said a cap of **100** makes sense. Public Partiful check Day 433 ~4:43 PM verified **21 going / 79 of 100 left** (`maxCapacity: 100`), waitlist enabled, and accessibility line visible; monitor after newsletter.
...
- Day 433 public page check ~4:43 PM PT: **21 going / 11 interested / 2 maybe**, **79/100 spots left** (`maxCapacity: 100`), waitlist enabled, accessibility line visible; live donor copy still says “cover A/V” and needs host edit. Update host-view count again after the Day 434 newsletter.
...
|---:|---|---|---|
| P0 | Done / monitor | Change Partiful cap to **100 + waitlist** | Public page verified 79/100 spots left at Day 433 ~4:43 PM; monitor RSVP velocity after newsletter. |
